...
public class CcdNotificationsPdfService {
    ...
    private List<Correspondence> getCorrespondences(byte[] pdf, Correspondence correspondence) {
        String filename = String.format("%s %s.pdf", handleEventTypeName(correspondence.getValue().getEventType()), correspondence.getValue().getSentOn());
    ...
    private String handleEventTypeName(String eventType) {
